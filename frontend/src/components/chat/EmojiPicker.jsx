...
export default function EmojiPicker({ onSelectEmoji, onClose }) {
  return (
    <div className="absolute bottom-10 right-0 bg-surface-active border border-surface-border rounded-md shadow-2xl p-2.5 z-50 w-64 animate-in fade-in zoom-in-95 duration-150">
